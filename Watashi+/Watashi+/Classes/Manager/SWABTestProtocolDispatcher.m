...
#import "SWABTestProtocolDispatcher.h"
...
@interface SWABTestProtocolDispatcher ()
...
{
    return [[SWABTestProtocolDispatcher alloc] initWithProtocol:protocol withIndexImplemertor:indexImplemertor toImplemertors:implemertors];
}
